...
# Change: Keep default notification area
...
# Change: Keep default control panel
...
# Change: Keep default JPEG quality
...
# Change: Keep default language setting for apps 
...
# Consider change: UAC off (this) or default (below)
...
#>
# Change: Keep default Windows features
...
#>
# Change: Keep default Windows capabilities
...
<#
	...
	Чтобы заработала данная функция, уровень сбора диагностических данных ОС будет установлен на "Необязательные диагностические данные" и включится создание отчетов об ошибках Windows
#>
# Change: Keep default troubleshooting
...
# Change: Keep default thumbnail handling
...
# Change: Keep default active hours
...
# Change: Keep default restart after updates
...
# Keep default app settings in start menu
...
# Change: Default UWP background setting
...
# Change: keep default graphics settings
...
#>
# Change: No custom software cleanup task
...
#>
# Change: don't change event viewer
...
# Change: Keep default photos context
